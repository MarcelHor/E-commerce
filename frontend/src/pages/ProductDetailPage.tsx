...
export default function ProductDetailPage() {
    ...
    const fetchProductDetail = async () => {
        let baseUrl = "https://eshopapi.marcel-horvath.me/api/v1/products";
        if (subcategory) {
    ...
    const handleBuyNow = (product: ProductDetailProps, quantity: number) => {
        if (!product.in_stock){
            alert("Out of stock");
            return;
        }
    ...
    return (
        <div className="flex flex-col md:flex-row justify-center items-center bg-white text-black py-10 mt-5 mx-4 md:mx-32">
            <div className="w-full md:w-1/2 flex justify-center items-center">
                <img
                    src={`https://eshopapi.marcel-horvath.me${product.get_image}`}
                    alt={product.name}
            ...
            <div className="w-full md:w-1/2 px-4 md:px-10">
                ...
                <div className="flex space-x-2 py-2">
                    ...
                    <button className="bg-neutral-800 text-white font-bold py-2 px-4 rounded-lg space-x-2" onClick={() => handleBuyNow(product, quantity)}>
